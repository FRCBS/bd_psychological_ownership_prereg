...
ggplot(df_scores, aes(x = psycown, y = intention,
                      color = as.factor(de01))) +
  geom_point(alpha = 0.7, size = 2.5) +
  labs(title = "Latent Factor Scores by de01 and de02",
       x = "Psychological Ownership",
       y = "Donation Intention",
       color = "gender") +
  theme_minimal()


ggplot(df_scores, aes(x = p, y = intention,
                      color = as.factor(de01))) +
  geom_point(alpha = 0.7, size = 2.5) +
  labs(title = "Latent Factor Scores by de01 and de02",
       x = "Psychological Ownership",
...
ggplot(df_scores, aes(x = psycown, y = intention,
                      color = as.factor(de02),
                      shape = as.factor(de01))) +
  geom_point(alpha = 0.7, size = 2.5) +
  labs(title = "Latent Factor Scores by de01 and de02",
       x = "Psychological Ownership",
       y = "Donation Intention",
...
>>>>>>> ee3050c55c3e75c3dd19c1a8d96fa7c2f0d5d570
