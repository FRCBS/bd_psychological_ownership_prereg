...
Having a donor self-identity is considered a key motivational factor for sustained blood donation behaviour (Callero, 1985; Ferguson et al., 2020). Within Identity Theory, when a new donor first gives blood they develop a role-identity (I am a blood donor). As a novice donor continues to donate, this role-identity is validated, and thus blood donation becomes part of a donor’s self-identity (Being a blood donor is an important part of who I am; Grube & Piliavin, 2000; Masser, White, Hyde, Terry, & Robinson, 2009). However, despite the link between donor self-identity and donor retention, there are currently no interventions which can foster a sense of identity in donors that do not rely exclusively on repeat donation behaviour. 
Psychological ownership (this is mine) is the sense of ownership experienced over both material (e.g., blood collection agency) and abstract immaterial (e.g., blood donation behaviour) possessions (Pierce et al., 2001). The ownership volunteers experience over a non-profit organisation has been linked to sustained volunteering behaviour (Ainsworth, 2020). Further, psychological ownership is theoretically associated with identity as it has been proposed that through possession identity is established and maintained (Dittmar, 1992; Pierce et al., 2001). 
In an Australian donor context, we have provided initial support for the idea that psychological ownership experienced towards a blood collection agency both increases with past donation experience and is positively associated with blood donor self-identity (Edwards et al., 2023). Further, in a series of semi-structured interviews we have shown that Australian blood donors primarily expressed ownership over the blood donation process (role behaviour), not the blood collection agency (organisation). As such, interventions that enhance the amount of psychological ownership donors experience over their donation have the potential to impact donor retention. 
In this study we try to repeat results from Edwards et al., 2023 in Finland by collecting similar questionnaire data and analysing them with a structural equation model. We include pre-registered R analysis code for direct repetition of Edwards et al., 2023 in Appendix 1.
...
2. Psychological ownership over FRCBS increases with donation experience. That is the lower bound of effect estimate of 95% standardized confidence or credible interval of direct effect of past donation behavior to psychological ownership is higher than zero.
...
Cross sectional survey stud ymodelled with a structural equation model.
...
A set of blood donors will be randomly selected from all active blood donors in FRBS register.
...
An e-mail inviting to fill an online questionnaire will be sent to the randomly selected blood donors. No recompensation will be offered to participants.Participants must be between 18 and 65 years old.
...
All likert scale measured variables will be treated as numeric as well number of life time donations (bd02) and number of donations in last years (bd03). Last donation date (bd04) will transformed "bd04 / 10^-(2 - str_length(as.numeric(max(bd04))))". 
...
For structural equation models using latent variables  
...
<tr>
<td>
po01 1. I feel a very high degree of personal ownership of donating blood.
</td>
</tr>
<td>
po02 2. I feel like donating blood belongs to me.
</td> </tr>
<tr>
<td>
po03 3. I feel like I own donating blood.
</td> </tr>
<tr> <td></td>
...
<tr>
<td>
si01 1. Donating blood is important to me.
</td> <tr>
si02 2. I am like the kind of person who donates blood.
</td> </tr>
<tr> 
<td>
si03 3. Donating blood is an important part of who I am.
</td> </tr>
<tr> <td></td>
...
<tr>
<td>
it01 1. I would like to donate blood in the future.
</td>   </tr>
<tr>
<td>
it02 2. I intend to donate blood in the future.
</td> </tr>
<tr>
<td>
it03 3. I intend to make more than just a one-off blood donation.
</td></tr>
<tr><td></td>
<td>
...
<tr>
<td>
ie01 1. I would be willing to donate blood if I received an urgent callout from the Finnish Red Cross Blood Service.
</td></tr>
<tr><td></td> 
<td>
...
<tr>
<td>
ac01  1. I have influence over the things that affect me while donating blood.
</td></tr>
<tr>
<td>
ac02 2. I control the location and scheduling for donating blood.
</td></tr>
<tr>
<td>
ac03 3. I influence decisions related to my blood donation.
</td></tr>
<tr>
<td>
ac04 4. In general, I have control over donating blood.
</td></tr>
<tr><td></td>
<td>
Intimate knowledge
...
<tr>
<td>
ai01 1. I am intimately familiar with what is going on with regard to donating blood.
</td></tr>
<tr>
<td>
ai02 2. I have a depth of knowledge as it relates to donating blood.
</td></tr>
<tr>
<td>
ai03 3. I have a comprehensive understanding of donating blood.
</td></tr>
<tr>
<td>
ai04 4. I have a broad understanding of donating blood.
</td></tr>
<tr><td></td>
...
<td>
iv01 1.	I have invested a major part of myself into donating blood.
</td></tr>
<tr>
<td>
iv02 2. I have invested a significant amount of my time into donating blood.
</td></tr>
<tr>
<td>
iv03 3. Overall, I invested a lot into donating blood.
</td></tr>
<tr><td></td>
...
<tr>
<td>
bd01 1. Do you believe that you are currently eligible to donate blood [yes, no, unsure]
</td></tr>
<tr>
<td>
bd02 2. How many times in total have you donated blood at the Finnish Red Cross Blood Service Finland? [select number]
</td></tr>
<tr>
<td>
bd03 3. How many times in the last two years have you donated at the Finnish Red Cross Blood Service? [select number]
</td></tr>
<tr>
<td>
bd04 4. When did you last attend a Finnish Red Cross blood donation centre with the intention of donating blood? [select date]
</td></tr>
<tr><td></td>
...
<tr>
<td>
de01 1. What is your gender? [man, woman, non-binary, prefer to not disclose, prefer to self-describe (open response)]
</td></tr>
<tr>
<td>
de02 2. How old are you today? [select number]
</td></tr>
</table>
...
sum scores and latent variables
...
SEM include R from preregistartion code
...
All donors answering to question de01 other than "man" or "women" will be excluded as donation policies depend on sex. All donors answering to question bd01 "no" will be excluded as we are interested in person eligible to donate.
...
The survey platform only reports completed questionnaires and all questions are obligatory. Hence there will be no missing data.
