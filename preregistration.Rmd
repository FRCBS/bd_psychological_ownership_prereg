...
c. Sum score model with FIML for missing data

d. Latent factor model with robust estimator

e. Latent factor model with boostrapping

f. Latent factor model with FIML for missing data
...
Missing data will be analysed (see Appendix 1 for details) for possible biases and Little’s MCAR test carried out to assess randomness of missing data. Models using robust maximum likelihood or bootstrapped maximum likelihood estimation will be fitted with "listwise" deletion of missing data and in addition models using maximum likelihood estimator and "full information maximum likelihood" approach to deal with missing data will be fitted. All these results will be reported and discussed, acknowledging that there is no well-accepted method of dealing with data that is not missing at random
