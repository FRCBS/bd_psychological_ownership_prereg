...
Number of life time donations (bd02) and number of donations in last years (bd03) and likert scale measured variables (po01-3, si01-03, it01-03, ac01-04, iv01-03) will be treated as numeric. Last donation date (bd04) will transformed "bd04 / 10^-(1 - str_length(as.numeric(max(bd04))))". 
...
In supplement we will report results from all models included in preregistered analysis (Appendix 1), but as the main results we will report the model with highest Comparative Fit Index (CFI). Among models with identical CFIs we will choose the model which gives most conservative i.e. lowest estimate of ind_eff =  a1* d21 * b2. 95 % confidence or credible intervals will be used to decide if an effect is considered significant or not.
