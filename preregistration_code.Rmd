...
data.fit <- data %>%
  ...
  mutate(
    ss_psycown = scale(as.numeric(po01) + as.numeric(po02) + as.numeric(po03)),
    ss_selfid = scale(as.numeric(si01) + as.numeric(si02) + as.numeric(si03)),
    ss_intention = scale(as.numeric(it01) + as.numeric(it02) + as.numeric(it03))
    )
